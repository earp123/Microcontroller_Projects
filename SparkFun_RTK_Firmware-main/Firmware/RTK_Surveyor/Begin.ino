...
{
  //~SWR~ don't need code for anything other than RTK_EXPRESS
  if (productVariant == RTK_SURVEYOR)
  {
  ...
  {
    //~SWR~ this if-else can be reduced to systemState = STATE_ROVER_NOT_STARTED
    //    ~ BASE is not desired and L Band is not available.
    /*if (online.lband == false)
