...
void setup() {
  ...
  //digitalWrite(3, HIGH); // Touch controller chip select (if used)
  //digitalWrite(34, HIGH); // TFT screen chip select
  digitalWrite( A5, HIGH); // SD card chips select, must use GPIO 5 (ESP32 SS)
