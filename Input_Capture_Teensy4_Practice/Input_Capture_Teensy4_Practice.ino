...
void capture_init() {
  ...
  TMR1_COMP12 = 0x1d4c;  // count up to this val, interrupt,  and start again
  TMR1_CMPLD12 = 0x1d4c;

  TMR1_SCTRL2 = TMR_SCTRL_CAPTURE_MODE(1);  //rising
  attachInterruptVector(IRQ_QTIMER1, my_isr);
  TMR1_SCTRL2 = TMR_SCTRL_IEFIE | TMR_SCTRL_CAPTURE_MODE(3); // enable interrupts
  //TMR1_CSCTRL2 = TMR_CSCTRL_TCF1EN;  // enable interrupt
  NVIC_ENABLE_IRQ(IRQ_QTIMER1);
  TMR1_CTRL2 =  TMR_CTRL_CM(1) | TMR_CTRL_PCS(8) | TMR_CTRL_SCS(2);// | TMR_CTRL_LENGTH ; // prescale
...
void setup()   {
  ...
  //analogWrite(23, 2);  // jumper 23 to pin 11
